export const A_FormatYSinglePageInputOptions: SinglePageMockupInputOptions = {
  ...
  imagePlaceholderX: 5,
  imagePlaceholderY: 5,
  imagePlaceholderIconY: 31,
  imagePlaceholderIconX: 38,
  imagePlaceholderIconScale: 0.3,
  calendarGridLeftIndent: 5,
  calendarGridTopIndent: 65,
  dayCellStyles: 'fill: none; stroke: none; stroke-width: 0;',
  monthTitleX: 2.5,
  monthTitleY: 1.8,
